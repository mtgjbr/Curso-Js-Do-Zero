...
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;IACI,mCAAmC;KAClC,uCAAuC;AAC5C;;AAEA;CACC,sBAAsB;CACtB,UAAU;;AAEX;AACA;IACI,SAAS;IACT,UAAU;IACV,+BAA+B;IAC/B,mCAAmC;IACnC,gBAAgB;IAChB,kBAAkB;AACtB;AACA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,uBAAuB;IACvB,aAAa;IACb,mBAAmB;;AAEvB;CACC;IACG,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;AACA;IACI,eAAe;IACf,YAAY;IACZ,eAAe;;AAEnB;CACC;IACG,uCAAuC;AAC3C;CACC;IACG,WAAW;IACX,+BAA+B;IAC/B,gBAAgB;IAChB,eAAe;IACf,kBAAkB;IAClB,YAAY;IACZ,eAAe;IACf,gBAAgB;AACpB;AACA;IACI,uCAAuC;AAC3C","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap');\r\n:root{\r\n    --primary-color: rgb(14, 142, 112) ;\r\n     --primary-color-darker: rgb(3, 36, 28) ;\r\n}\r\n\r\n*{\r\n box-sizing: border-box;\r\n outline: 0;\r\n \r\n}\r\nbody{\r\n    margin: 0;\r\n    padding: 0;\r\n    background:var(--primary-color);\r\n    font-family:'open-sans', sans-serif;\r\n    font-size: 1.3em;\r\n    line-height: 1.5em;\r\n}\r\n.container{\r\n    max-width: 640px;\r\n    margin: 50px auto;\r\n    background: floralwhite;\r\n    padding: 20px;\r\n    border-radius: 10px;\r\n    \r\n}\r\n input, form label, form button{\r\n    display: block;\r\n    width: 100%;\r\n    margin-bottom: 10px;\r\n}\r\ninput{\r\n    font-size: 24px;\r\n    height: 50px;\r\n    padding: 0 20px;\r\n\r\n}\r\n input:focus{\r\n    outline: 1px solid var(--primary-color);\r\n}\r\n button{\r\n    border:none;\r\n    background:var(--primary-color);\r\n    color: aliceblue;\r\n    font-size: 18px;\r\n    font: weight 700px; ;\r\n    height: 50px;\r\n    cursor: pointer;\r\n    margin-top: 30px;\r\n}\r\nform button:hover{\r\n    background: var(--primary-color-darker);\r\n}"],"sourceRoot":""}]);
// Exports
...
var voltas = document.querySelector(".voltas");
var Cronômetro = exports["default"] = /*#__PURE__*/function () {
  function Cronômetro() {
    _classCallCheck(this, Cronômetro);
  ...
  return _createClass(Cronômetro, [{
    key: "criali",
    ...
    key: "atualizarTela",
    value: function atualizarTela(hora) {
      relogio.innerHTML = hora;
    }
  }, {
    key: "criaRelogio",
    value: function criaRelogio() {
      var data = new Date();
    }
  }, {
    key: "pausar",
    ...
    key: "marcarVolta",
    value: function marcarVolta() {
      if (this.segundos === 0) {
        alert("comece para adicionar voltas");
      } else {
        var li = this.criali();
        li.textContent = "".concat(this.posicao, "\xBA: ").concat(this.horaFormatada);
    ...
    value: function comecar() {
      var _this = this;
      if (this.contador) {
        alert("voce já começou a fazer isso");
      } else {
        this.contador = setInterval(function () {
          var data = new Date(_this.segundos * 1000);
          data = data.toLocaleTimeString('pt-Br', {
            hour12: false,
            timeZone: "utc"
          });
          _this.horaFormatada = data;
          _this.atualizarTela(_this.horaFormatada);
          // console.log(data)
          _this.segundos++;
        }, 1000);
      }
...
var _cronometro = _interopRequireDefault(__webpack_require__(/*! ./modules/cronometro */ "./src/modules/cronometro.js"));
...
//let timer = "";
var segundos = 0;
var c1 = new _cronometro["default"]();
document.addEventListener('click', function (e) {
  console.log(e.target);
  if (e.target.classList.contains("comecar")) {
    // confere se nas classes do botão tem começar
    c1.comecar();
  }
